...
#this makes it go down: cyprus.set_pwm_values(1, period_value=100000, compare_value=10000, compare_mode=cyprus.LESS_THAN_OR_EQUAL)
#this makes it go up: cyprus.set_pwm_values(1, period_value=100000, compare_value=0, compare_mode=cyprus.LESS_THAN_OR_EQUAL)